...
public class nearByAdapter extends RecyclerView.Adapter<nearByAdapter.Myviewholder> {
    ...
    private final ArrayList<nearByModel> list;
    ...
    public class Myviewholder extends RecyclerView.ViewHolder {
        ...
        public void getUserInfo(String userId) {
            ...
            userNameRef.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    DatabaseReference userBio = FirebaseDatabase.getInstance().getReference("UserDetails");
                    userBio.child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot ds) {
                          String profession = ds.child("user_bio").getValue().toString();
                            extra = profession.length()/2;
                        }
